...
However, those available Google services (including google.com.hk), were disturbed, and finally, gradually blocked by the PRC government, with **Google taking no further action.**. Obviously, the only reason those 551,615,600 users have no access to Google's service is **the increasingly severe network censorship in Mainland China**.

Ironically, the original author of [2] claimed that "your small group to deprive them of the technical benefits". I 
...
事实上不成立之2：百度的市占比并不怎么受到 Google 的「在华」与否的影响。在Google「退出」中国之前，百度也有过市占比达到 71.03% 的高光时刻（Aug 2009），在 Google 「退出」中国之后，百度也有过跌至 50.69% 的时候（Apr 2014）。对比 Google 宣布「退出」中国的 2010 年三月和如今的 2018 年十月，百度的市场份额不过是从 55.57% 变为了 65.05%, 而纵观从 statcounter 收录百度以来（Mar 2009）其市占比的变化，大多数时间里都是在 60% 以上、80% 以下的范围内来回浮动。换句话说，百度在中国大陆的搜索引擎市场从来就占据主导地位，与 Google 的「在华」与否并不构成怎样的相关性。

![](http://hiberna.memorata.me/ud/StatCounter-search_engine-CN-monthly-200901-201811.png)

（稍微截去左边一点，就会给人造成一种 Google 「一走」，百度就称霸的假象（最左边一点点一开始由于百度的数据未加入所以图像不准确，百度数据的引入在最左边百度线上的那个三角处）。其实人家百度的市占比一直很稳定，换句话说——爱用百度的人，你给个别的搜索引擎人家也不用。）
